# Generated by:
#
#     mix ichor.gen priv/grammar/regsynth.aether --module RegSynth.Grammar --actions RegSynth.Parser.Actions --out lib/reg_synth/grammar.ex
#
# Do not edit by hand -- rerun the command above instead.
defmodule RegSynth.Grammar do
  @moduledoc false
  (
    ...
    def parse_rule__concat(stream, pos, ref_stack, context) do
      Parser.plus(&parse_expr__33/4, stream, pos, ref_stack, context)
    end
      ...
      if pos >= tuple_size(stream) do
        ...
        case parse_rule__expr(stream, pos, [0], ctx) do
          {:ok, new_pos, _ref_stack, raw_captures} ->
            case Ichor.Actions.evaluate(:expr, raw_captures, RegSynth.Parser.Actions, ctx, %{
                   atom: MapSet.new([]),
                   bound: MapSet.new([:DIGIT]),
                   group: MapSet.new([]),
                   expr: MapSet.new([:PIPE, :concat]),
